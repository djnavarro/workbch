...
create_job("hitmebaby", "Signal detection modelling", "britney", priority = 2)
create_job("spinspinsugar", "Check for periodicities", "sneaker", priority = 1)
create_job("boys", "Distributional assumptions", "lizzo", priority = 2)
```
```{r busystate}
view_jobs()
```
